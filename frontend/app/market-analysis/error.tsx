    ...
    <div className="flex flex-col items-center justify-center min-h-[40vh] space-y-5 text-center px-4">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          The Property Market Analysis encountered an error.
        </p>
        {error.message && (
      ...
      <div className="flex gap-3">
        <button
          onClick={reset}
          className="flex items-center gap-2 text-sm font-medium bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition-colors"
        >
